...
import base64 #to open .gif file in streamlit
...
app_mode = st.sidebar.selectbox('Select Page', ['Homepage', 'Prediction']) #Creating two pages
...
if app_mode == "Homepage":
    ...
    #Creating onehot encoding for the Dependent variable
    ...
    #Creating onehot encoding for the property variable
